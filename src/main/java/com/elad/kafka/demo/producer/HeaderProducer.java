...
public class HeaderProducer implements Runnable{
    ...
    public void objectProducer() throws InterruptedException {
        ...
        while(true){
            ...
            headers.add(new RecordHeader("type", "tid1".getBytes()));
            headers.add(new RecordHeader("cluster", "va".getBytes()));
            ProducerRecord<String,ETLEvent> record= new ProducerRecord(topic, partition, System.currentTimeMillis(), null, createSodaEvent(), headers);
